            ...
            return (
                <div>
                    ...
                    <div className="d-flex justify-content-left">
                        <button className="btn btn-light col-2 mx-auto text-center custom-button" onClick={() => window.location.href = `http://localhost:5173/nuevo-nodo/${selectedChainID}`}>CREAR NODO</button>
                    </div>
                </div>
            );
        } else {
